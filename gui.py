...
class ExportGUI(tk.Toplevel):
    def __init__(self, **kw):
        ...
        self.lb_tips.configure(text='''导出进度：100%''')
        self.lb_tips.configure(textvariable=self.lb_tips_val)
        self.lb_tips_val.set('''导出进度：100%''')
        ...
        self.btn_cancel.place(relx=0.763, rely=0.682, height=27, width=87)
        ...
        self.btn_pause.place(relx=0.55, rely=0.682, height=27, width=87)
